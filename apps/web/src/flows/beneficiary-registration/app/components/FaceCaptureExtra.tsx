export function FaceCaptureExtra() {
  return (
    <div className="h-full flex flex-col p-6 bg-neutral-50">
      {/* Instruction */}
      <div className="mb-4 text-center">
        <div className="w-52 h-5 bg-neutral-300 mx-auto mb-1"></div>
        <div className="text-xs text-neutral-600 mt-2">
          "Take one more photo if needed"
        </div>
      </div>

      {/* Camera view */}
      <div className="flex-1 bg-neutral-200 border-2 border-neutral-400 relative mb-4 flex items-center justify-center">
        <div className="w-28 h-36 border-4 border-neutral-600 rounded-full relative">
      ...
      <div className="flex gap-2">
        <div className="flex-1 h-14 bg-white border-2 border-neutral-400 flex items-center justify-center">
          <span className="text-sm text-neutral-600">Skip</span>
        </div>
        <div className="flex-1 h-14 bg-neutral-800 flex items-center justify-center">
          <div className="w-10 h-10 bg-white rounded-full border-4 border-neutral-300"></div>
        </div>
      </div>
    </div>
  );
