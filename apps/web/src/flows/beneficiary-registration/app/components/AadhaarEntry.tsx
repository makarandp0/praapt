export function AadhaarEntry() {
  return (
    <div className="h-full flex flex-col p-8 bg-neutral-50">
      ...
      {/* Four digit boxes */}
      <div className="mb-4">
        <div className="w-36 h-4 bg-neutral-200 mb-3"></div>
      ...
      <div className="mb-6 p-3 bg-white border border-neutral-300">
        ...
        <div className="w-4/5 h-3 bg-neutral-200"></div>
        <div className="mt-2 text-xs text-neutral-600">
          "Only last 4 digits. Not used as full identity."
        </div>
      </div>
